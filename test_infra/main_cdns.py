...
class DNSTapContainer:
	...
	def clean(self):
		...
		subprocess.call(' docker container rm {}'.format(self.container_name), shell=True)
		return
...
class UnboundContainer:
	...
	def log_save(self, curr_round_num):
		...
		subprocess.call('sudo rm -rf {dump_folder}/unbound.log'.format(dump_folder = self.dump_folder), shell=True)
...
class PowerDNSContainer:
	...
	def log_save(self, curr_round_num):
		...
		subprocess.call('sudo rm -rf {dump_folder}/powerdns.log'.format(dump_folder = self.dump_folder), shell=True)
